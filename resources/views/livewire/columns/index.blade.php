...
@else
    ...
    <div class="grid grid-cols-12 gap-6">
        <a class="zoom-in col-span-12 lg:col-span-6 box pt-5">
            @livewire('columns.h-sections')
        </a>
        <a class="zoom-in col-span-12 lg:col-span-6 box pt-5">
            @livewire('columns.i-sections')
        </a>
    </div>
    <div class="my-10">
