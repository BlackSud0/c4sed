    ...
    <div class="box w-full border-b-2 border-purple-600 shadow-lg p-4">
        ...
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 md:col-span-6 px-2">
                ...
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">Section</span><span class="mx-auto text-gray-700 dark:text-gray-300">{{$data->column->{$data->column_type}->designation}} {{$data->column->column_type === 'HSection' ? 'UC' : 'UB'}}</span><span class="ml-auto text-gray-500 text-xs">This is a {{$data->section_class}} section</span></div>
