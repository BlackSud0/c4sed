    ...
    <div class="box w-full border-b-2 border-purple-600 shadow-lg p-4">
        ...
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 md:col-span-6 px-2">
                ...
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">Section</span><span class="mx-auto text-gray-700 dark:text-gray-300">{{$data->column->{$data->column_type}->designation}} {{$data->column->column_type === 'HSection' ? 'UC' : 'UB'}}</span><span class="ml-auto text-gray-500 text-sm">This is a {{$data->section_class}} section</span></div>
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">D = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-sm">{{$data->column->{$data->column_type}->h}} mm</span><span class="ml-auto text-gray-500 text-sm">Depth of section</span></div>
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">t = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-sm">{{$data->column->{$data->column_type}->s}} mm</span><span class="ml-auto text-gray-500 text-sm">Thickness of web</span></div>
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">T = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-sm">{{$data->column->{$data->column_type}->t}} mm</span><span class="ml-auto text-gray-500 text-sm">Thickness of flange</span></div>
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">b/T = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-sm">{{$data->column->{$data->column_type}->b2t}}</span><span class="ml-auto text-gray-500 text-sm">Ratios for buckling(flange)</span></div>
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">d/t = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-sm">{{$data->column->{$data->column_type}->ds}}</span><span class="ml-auto text-gray-500 text-sm">Ratios for buckling(web)</span></div>
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">I<a style="left:1pt;position:relative;top:5pt;">x</a> = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-sm">{{$data->column->{$data->column_type}->Ix}} cm<a class="text-sm" style="position:relative;top:-5pt;">4</a></span><span class="ml-auto text-gray-500 text-sm">Second moment of area</span></div>
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">r<a style="left:1pt;position:relative;top:5pt;">y</a> = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-sm">{{$data->column->{$data->column_type}->ry}} cm</span><span class="ml-auto text-gray-500 text-sm">Radius of Gyration (y-y)</span></div>
                <div class="flex border-t border-b mb-6 border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">A = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-sm">{{$data->column->{$data->column_type}->A}} mm<a class="text-sm" style="position:relative;top:-5pt;">2</a></span><span class="ml-auto text-gray-500 text-sm">Area of section</span></div>
            </div>
            <div class="col-span-12 md:col-span-6 px-2">
                <div class="flex mb-4">
                ...
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">L = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-sm">{{$data->column->L}} m</span><span class="ml-auto text-gray-500 text-sm">Span / Length</span></div>
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">D.L = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-sm">{{$data->column->DL}} KN</span><span class="ml-auto text-gray-500 text-sm">Dead Load</span></div>
                <div class="flex border-t @if(!$data->column->WL) border-b @endif border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">L.L = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-sm">{{$data->column->LL}} KN</span><span class="ml-auto text-gray-500 text-sm">Live Load</span></div>
                @if($data->column->WL)
                <div class="flex border-t border-b border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">W.L = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-sm">{{$data->column->WL}} KN</span><span class="ml-auto text-gray-500 text-sm">Wind Load</span></div>
                @endif
                <div class="flex mb-4">
                ...
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">Grade = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-sm">{{$data->column->grade}}</span><span class="ml-auto text-gray-500 text-sm">Steel grade</span></div>
        ...
        <div class="grid grid-cols-12 gap-6 pb-6">
            <div class="col-span-12 md:col-span-6 px-2">    
                ...
                <p class="mb-2 text-sm flex leading-relaxed text-gray-900 dark:text-gray-300">λ = {{round($data->Lambda, 2)}} , => p<a class="text-sm mr-1" style="position:relative;top:4pt;">c</a> = {{round($data->pc, 2)}} N/mm<a class="text-sm" style="position:relative;top:-5pt;">2</a></p>
                ...
                <p class="mb-2 text-sm flex leading-relaxed text-gray-900 dark:text-gray-300">P<a class="text-sm mr-1" style="position:relative;top:4pt;">c</a> = {{round($data->Pc, 2)}} KN</p>
                <p class="mb-2 text-sm flex leading-relaxed text-gray-900 dark:text-gray-300">P<a class="text-sm mr-1" style="position:relative;top:4pt;">c</a> > W => {{round($data->Pc, 2)}} > {{round($data->W, 2)}} <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" class="text-green-500 w-6 h-5 ml-3 mr-1" viewBox="0 0 24 24"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"></path><path d="M22 4L12 14.01l-3-3"></path></svg><span class="title-font text-green-500 font-bold">OK</span></p>
