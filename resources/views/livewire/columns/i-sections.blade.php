<form class="form form-horizontal" wire:submit.prevent="CreateISection">
<div class="font-medium text-center text-base text-gray-800 dark:text-gray-200">Rolled I-Section</div>
<img class="px-4 w-2/3 mx-auto" src="{{ asset('assets/img/Column/I-Section.svg') }}" >
