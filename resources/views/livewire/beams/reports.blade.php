    ...
    <div class="box w-full border-b-2 border-purple-600 shadow-lg p-4">
        ...
        <div class="grid grid-cols-12 py-2">
            <div class="col-span-12 md:col-span-6 px-2">
                ...
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">b/T = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-xs">{{$data->beam->designation->b2t}}</span><span class="ml-auto text-gray-500 text-xs">Ratios for buckling(flange)</span></div>
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">d/t = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-xs">{{$data->beam->designation->ds}}</span><span class="ml-auto text-gray-500 text-xs">Ratios for buckling(web)</span></div>
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">I<a style="left:1pt;position:relative;top:5pt;">x</a> = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-xs">{{$data->beam->designation->Ix}} cm<a class="text-xs" style="position:relative;top:-5pt;">4</a></span><span class="ml-auto text-gray-500 text-xs">Second moment of area</span></div>
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">Z<a style="left:1pt;position:relative;top:5pt;">x</a> = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-xs">{{$data->beam->designation->Zx}} cm<a class="text-xs" style="position:relative;top:-5pt;">3</a></span><span class="ml-auto text-gray-500 text-xs">Elastic modulus (X-X)</span></div>
            ...
            <div class="col-span-12 md:col-span-6 px-2">
                ...
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">L = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-xs">{{$data->beam->L}} m</span><span class="ml-auto text-gray-500 text-xs">Span / Length</span></div>
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">D.L = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-xs">{{$data->beam->DL}} KN/m</span><span class="ml-auto text-gray-500 text-xs">Dead Load</span></div>
                <div class="flex border-t @if(!$data->beam->WL) border-b @endif border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">L.L = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-xs">{{$data->beam->LL}} KN/m</span><span class="ml-auto text-gray-500 text-xs">Live Load</span></div>
                @if($data->beam->WL)
                <div class="flex border-t border-b border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">W.L = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-xs">{{$data->beam->WL}} KN/m</span><span class="ml-auto text-gray-500 text-xs">Wind Load</span></div>
                @endif
                <div class="flex mb-4">
                ...
                <div class="flex border-t border-dashed border-gray-400 dark:border-gray-600 py-1 text-sm"><span class="text-gray-900 dark:text-gray-300">Grade = </span><span class="mx-auto text-gray-600 dark:text-gray-400 text-xs">{{$data->beam->grade}}</span><span class="ml-auto text-gray-500 text-xs">Steel grade</span></div>
        ...
        <div class="grid grid-cols-12 gap-6 py-2">
            <div class="col-span-12 md:col-span-8 px-2">
                ...
                <p class="mb-2 text-sm leading-relaxed text-gray-900 dark:text-gray-300">M<a class="text-xs mr-1" style="left:1pt;position:relative;top:4pt;">max</a> = {{$data->Mmax}} KN.m , V<a class="text-xs mr-1" style="left:1pt;position:relative;top:4pt;">max</a> = {{$data->Vmax}} KN</p>
                ...
                <p class="mb-2 text-sm leading-relaxed text-gray-900 dark:text-gray-300">P<a class="text-xs mr-1" style="left:1pt;position:relative;top:4pt;">v</a> = {{round($data->Pv, 2)}} KN</p>
                <p class="mb-2 text-sm flex leading-relaxed text-gray-900 dark:text-gray-300">P<a class="text-xs mr-1" style="left:1pt;position:relative;top:4pt;">v</a> > V<a class="text-xs mr-1" style="left:1pt;position:relative;top:4pt;">max</a> => {{round($data->Pv, 2)}} > {{round($data->Vmax, 2)}} <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" class="text-green-500 w-6 h-5 ml-3 mr-1" viewBox="0 0 24 24"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"></path><path d="M22 4L12 14.01l-3-3"></path></svg><span class="title-font text-green-500 font-bold">OK</span></p>
                ...
                <p class="mb-2 text-sm leading-relaxed text-gray-900 dark:text-gray-300">M<a class="text-xs mr-1" style="left:1pt;position:relative;top:4pt;">c</a> = {{round($data->Mc, 2)}} KN.m</p>
                <p class="mb-2 text-sm flex leading-relaxed text-gray-900 dark:text-gray-300">M<a class="text-xs mr-1" style="left:1pt;position:relative;top:4pt;">max</a> < M<a class="text-xs mr-1" style="left:1pt;position:relative;top:4pt;">c</a> <= 1.2 Py Zx => {{round($data->Mmax, 2)}} < {{round($data->Mc, 2)}} <= {{round($data->check_Mc, 2)}} <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" class="text-green-500 w-6 h-5 ml-3 mr-1" viewBox="0 0 24 24"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"></path><path d="M22 4L12 14.01l-3-3"></path></svg><span class="title-font text-green-500 font-bold">OK</span></p>
                ...
                <p class="mb-2 text-sm leading-relaxed text-gray-900 dark:text-gray-300">D<a class="text-xs mr-1" style="left:1pt;position:relative;top:4pt;">f</a> = {{round($data->Df, 2)}} mm</p>
                @if($data->beam->beam_type === 'Cantilever')
                <p class="mb-2 text-sm flex leading-relaxed text-gray-900 dark:text-gray-300">D<a class="text-xs mr-1" style="left:1pt;position:relative;top:4pt;">f</a> <= Length/180 => {{round($data->Df, 2)}} <= {{round($data->check_Df, 2)}} <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" class="text-green-500 w-6 h-5 ml-3 mr-1" viewBox="0 0 24 24"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"></path><path d="M22 4L12 14.01l-3-3"></path></svg><span class="title-font text-green-500 font-bold">OK</span></p>
                @else
                <p class="mb-2 text-sm flex leading-relaxed text-gray-900 dark:text-gray-300">D<a class="text-xs mr-1" style="left:1pt;position:relative;top:4pt;">f</a> <= Span/360 => {{round($data->Df, 2)}} <= {{round($data->check_Df, 2)}} <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" class="text-green-500 w-6 h-5 ml-3 mr-1" viewBox="0 0 24 24"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"></path><path d="M22 4L12 14.01l-3-3"></path></svg><span class="title-font text-green-500 font-bold">OK</span></p>
                @endif
