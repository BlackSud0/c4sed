<form class="form form-horizontal" wire:submit.prevent="CreateCantileverBeam">
<div class="font-medium text-center text-base text-gray-800 dark:text-gray-200">Cantilever</div>
<img class="px-4" src="{{ asset('assets/img/Beam/Cantilever.svg') }}" >
...
<div class="relative mt-2 text-gray-500 focus-within:text-purple-600">
    ...
    <button type="submit" class="absolute inset-y-0 right-0 px-4 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-r-md active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple disabled:opacity-25" wire:loading.attr="disabled">
    Analyze
    </button>
</div>
</form>