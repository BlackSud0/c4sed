...
<img class="px-4 w-2/3 mx-auto" src="{{ asset('assets/img/Angle/Double-angle.svg') }}" >
<div class="text-center relative @if($HideBoltHole) disabled @endif">
    <label class="font-medium text-sm text-gray-600 dark:text-gray-300" for="D">D :</label>
    <input type="text" @if($HideBoltHole) readonly @else wire:model.defer="state.D" @endif class="w-20 h-7 text-xs text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" placeholder="Bolt hole">
