...
class SingleEangle extends Component
{
    /**
     ...
     * @return void
     */
    public function CreateSingleEangle(EanglesCalculations $creater)
    {
        $this->resetErrorBag();
    ...
    {
        $sections = Eangle::all();
        return view('livewire.eangles.single-eangle', compact('sections'));
    }
}
